...
public class Board {
    ...
    public Board() {
        squares = Arrays.asList(
                ...
                new NotProperty(this, 17), // Community Chest
                ...
                new NotProperty(this, 20), // Free Parking
                new City(this, 21, PropertyType.RED, CityName.RED1), // Red 1
                new NotProperty(this, 22), // Chance
