...
public class PropertyUtils {
    ...
    private static void buyProperty(Player player, Property property, PlayerRepository playerRepository) throws Exception {
    ...
    public static void buyPropertyFromBoard(Player player, PlayerRepository playerRepository) throws Exception {
        ...
        buyProperty(player, property, playerRepository);
    }
}
